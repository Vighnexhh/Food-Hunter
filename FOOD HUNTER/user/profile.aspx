<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="FOOD_HUNTER.user.profile" %>
                                ...
                                <div class="d-flex justify-content-start">
                                    <div class="image-container">
                                        ...
                                        <div class="middle pt-2">
                                            <a href="Registration.aspx?id=<%= Session["userId"] %>" class="btn btn-warning">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        <div class="tab-plane fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedServices-tab"></div>
                                                    ...
                                                    <asp:Repeater ID="rOrders" runat="server">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    RS.<asp:Label ID="lblTotalPrice" runat="server" Text='<%# Eval("TotalPrice") %>'></asp:Label>
                                                                </td>
                                                                <td>
