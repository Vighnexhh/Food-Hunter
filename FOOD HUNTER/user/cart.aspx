<%@ Page Title="" Language="C#" MasterPageFile="~/user/user.Master" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="FOOD_HUNTER.user.cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>RS.<asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'></asp:Label>
                        ...
                        <td>RS.<asp:Label ID="lblTotalPrice" runat="server"></asp:Label>
                        </td>
                        <td>
