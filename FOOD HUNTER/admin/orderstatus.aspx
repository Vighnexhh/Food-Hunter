<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="orderstatus.aspx.cs" Inherits="FOOD_HUNTER.admin.orderstatus" %>
                                                    ...
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" runat="server" CssClass="badge badge-dark" CommandArgument='<%# Eval("OrderDetailsId") %>'
                                                                        CommandName="edit">
                                                                      <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4 mobile-inputs">
                                            <asp:Panel ID="pUpdateOrderStatus" runat="server">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="pb-5">
                                                        <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btn btn-inverse" OnClick="btnUpdate_Click"></asp:Button>
                                                        &nbsp;
                                                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-inverse" OnClick="btnCancel_Click"></asp:Button>
                                                    </div>
                                                </div>
                                            </asp:Panel>
                                        </div>
